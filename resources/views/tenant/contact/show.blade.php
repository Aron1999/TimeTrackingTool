...
@section('content')
    ...
    <div>
        <h1 class="text-3xl text-gray-500 font-sans">{{ $contact->name}}</h1>
        <contact inline-template :contact="{{ json_encode($contact) }}" formaction="{{  action('ContactController@update', $contact->id)  }}">
