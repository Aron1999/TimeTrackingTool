...
@section('content')
    ...
    <div>
        <h1 class="text-3xl text-gray-500 font-sans">{{ $organisation->name}}</h1>
        <organisation inline-template :organisation="{{ json_encode($organisation) }}" formaction="{{  action('OrganisationController@update', $organisation->id)  }}">
